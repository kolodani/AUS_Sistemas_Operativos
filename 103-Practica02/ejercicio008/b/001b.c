 ...
 *  Construir un programa en C que emplee popen(ver presentación dada en clases) donde el
...
int main()
{
    ...
    else
    {
        ...
        /* lectura por consola hasta un enter sin usar popen*/
        char c;
        while ((c = getchar()) != '\n')
        {
            write(fds[WRITE], &c, sizeof(char));
        }
    }
